...
# Load .env ourselves if nothing else has -- a preflight that reports
# "MISSING" for a perfectly good credential is worse than useless, because it
# sends you hunting a transfer problem that doesn't exist. Shared with
# tiktok_upload, which hit the same thing as a bare KeyError.
import env_file
env_file.load(quiet=False)
